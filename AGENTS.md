...
Keep the release URL, checksums, architecture mapping, service environment and
restart behavior identical in all three packaged Ansible resource trees.
